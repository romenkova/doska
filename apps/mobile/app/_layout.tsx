...
import { ShareIntentListener } from "@/components/shell/share-intent-listener"
        ...
        <QueryClientProvider client={queryClient}>
          <AppGate>
            ...
            <Stack screenOptions={headerOptions}>
              ...
              <Stack.Screen
                name={SCREENS.cardDeadline}
                options={sheetOptions}
              />
              <Stack.Screen
                name={SCREENS.cardPriority}
                options={sheetOptions}
              />
              ...
              <Stack.Screen
                name={SCREENS.folderActions}
                options={sheetOptions}
              />
              <Stack.Screen
                name={SCREENS.folderRename}
                options={sheetOptions}
              />
              <Stack.Screen name={SCREENS.columnNew} options={sheetOptions} />
              <Stack.Screen
                name={SCREENS.columnActions}
                options={sheetOptions}
              />
              <Stack.Screen
                name={SCREENS.columnDelete}
                options={sheetOptions}
              />
              <Stack.Screen
                name={SCREENS.search}
              ...
              />
              <Stack.Screen name={SCREENS.share} options={sheetOptions} />
              <Stack.Screen
                name={SCREENS.signIn}
